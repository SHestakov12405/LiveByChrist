...
class SleepRequiredExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithEvents
{
    public function collection()
    {
        $registrations = ConferenceRegistration::where('sleep', 'required')
            ->orderBy('city')
            ->get();
