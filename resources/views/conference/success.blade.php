...
<style>
    ...
    .triangle-1 { 
        ...
        border-bottom: 85px solid rgba(60, 171, 0, 0.5);
    ...
    .triangle-2 { 
        ...
        border-bottom: 60px solid rgba(109, 255, 5, 0.5);
    ...
    .triangle-3 { 
        ...
        border-bottom: 75px solid rgba(58, 255, 189, 0.5);
    ...
    .triangle-4 { 
        ...
        border-bottom: 100px solid rgba(3, 153, 0, 0.5);
        transform: rotate(-15deg);
        animation-delay: 3s;
    }
    ...
    .triangle-5 { 
        ...
        border-bottom: 70px solid rgba(54, 162, 35, 0.5);
    ...
    .triangle-6 { 
        ...
        border-bottom: 90px solid rgba(51, 140, 3, 0.5);
    ...
    .triangle-7 { 
        ...
        border-bottom: 72px solid rgba(102, 158, 12, 0.5);
    ...
    .triangle-8 { 
        ...
        border-bottom: 82px solid rgba(108, 217, 98, 0.5);
    ...
    .triangle-10 { 
        ...
        border-bottom: 88px solid rgba(50, 169, 23, 0.5);
        transform: rotate(-20deg);
    ...
    .triangle-11 { 
        ...
        border-bottom: 78px solid rgba(93, 187, 0, 0.5);
        transform: rotate(30deg);
    ...
    .triangle-12 { 
        ...
        border-bottom: 62px solid rgba(0, 255, 0, 0.5);
        transform: rotate(-35deg);
    ...
    .triangle-13 { 
        ...
        border-bottom: 75px solid rgba(0, 176, 76, 0.5);
        transform: rotate(40deg);
    ...
    .triangle-14 { 
        ...
        border-bottom: 98px solid rgba(62, 180, 15, 0.5);
    ...
    .triangle-16 { 
        ...
        border-bottom: 70px solid rgba(39, 146, 0, 0.5);
        transform: rotate(-45deg);
    ...
    @media (max-width: 768px) {
        .triangle-1 { border-left: 30px solid transparent; border-right: 30px solid transparent; border-bottom: 50px solid rgba(60, 171, 0, 0.5); }
        .triangle-2 { border-left: 22px solid transparent; border-right: 22px solid transparent; border-bottom: 38px solid rgba(46, 184, 0, 0.5); }
        .triangle-3 { border-left: 28px solid transparent; border-right: 28px solid transparent; border-bottom: 48px solid rgba(58, 255, 189, 0.5); }
        .triangle-4 { border-left: 35px solid transparent; border-right: 35px solid transparent; border-bottom: 60px solid rgba(3, 153, 0, 0.5); }
        .triangle-5 { border-left: 25px solid transparent; border-right: 25px solid transparent; border-bottom: 42px solid rgba(54, 162, 35, 0.5); }
        .triangle-6 { border-left: 32px solid transparent; border-right: 32px solid transparent; border-bottom: 55px solid rgba(51, 140, 3, 0.5); }
        .triangle-7 { border-left: 26px solid transparent; border-right: 26px solid transparent; border-bottom: 44px solid rgba(102, 158, 12, 0.5); }
        .triangle-8 { border-left: 29px solid transparent; border-right: 29px solid transparent; border-bottom: 50px solid rgba(108, 217, 98, 0.5); }
        ...
        .triangle-10 { border-left: 31px solid transparent; border-right: 31px solid transparent; border-bottom: 53px solid rgba(50, 169, 23, 0.5); }
        .triangle-11 { border-left: 28px solid transparent; border-right: 28px solid transparent; border-bottom: 47px solid rgba(93, 187, 0, 0.5); }
        .triangle-12 { border-left: 22px solid transparent; border-right: 22px solid transparent; border-bottom: 37px solid rgba(0, 255, 0, 0.5); }
        .triangle-13 { border-left: 27px solid transparent; border-right: 27px solid transparent; border-bottom: 45px solid rgba(0, 176, 76, 0.5); }
        .triangle-14 { border-left: 34px solid transparent; border-right: 34px solid transparent; border-bottom: 58px solid rgba(62, 180, 15, 0.5); }
        ...
        .triangle-16 { border-left: 25px solid transparent; border-right: 25px solid transparent; border-bottom: 42px solid rgba(39, 146, 0, 0.5); }
    }
...
<body class="bg-gray-800">
    ...
    <section class="relative flex items-center justify-center min-h-screen" 
        ...
        <!-- Hero Content -->
        <div class="relative z-10 flex flex-col items-center justify-center px-4 text-center text-green-50">
            <h1 class="mb-4 font-bold text-6xl leading-snug tracking-wide transition-opacity duration-[2s] opacity-0 lg:text-8xl"
            ...
            x-effect="$el.classList.toggle('opacity-100')">
                Вы успешно зарегестрировались на конференцию Живи Христом 2025!
            </p>
        </div>
